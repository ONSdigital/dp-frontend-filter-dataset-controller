...
func (m *MockFilterClient) GetJobState(ctx context.Context, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterID string) (filter.Model, error) {
	ret := m.ctrl.Call(m, "GetJobState", ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterID)
...
func (mr *MockFilterClientMockRecorder) GetJobState(ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterID interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJobState", reflect.TypeOf((*MockFilterClient)(nil).GetJobState), ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterID)
}

// GetOutput mocks base method
func (m *MockFilterClient) GetOutput(ctx context.Context, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterOutputID string) (filter.Model, error) {
	ret := m.ctrl.Call(m, "GetOutput", ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterOutputID)
	ret0, _ := ret[0].(filter.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFilterClientMockRecorder) GetOutput(ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterOutputID interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOutput", reflect.TypeOf((*MockFilterClient)(nil).GetOutput), ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, filterOutputID)
}
...
func (m_2 *MockFilterClient) UpdateBlueprint(ctx context.Context, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken string, m filter.Model, doSubmit bool) (filter.Model, error) {
	ret := m_2.ctrl.Call(m_2, "UpdateBlueprint", ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, m, doSubmit)
	ret0, _ := ret[0].(filter.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFilterClientMockRecorder) UpdateBlueprint(ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, m, doSubmit interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateBlueprint", reflect.TypeOf((*MockFilterClient)(nil).UpdateBlueprint), ctx, userAuthToken, serviceAuthToken, collectionID, downloadServiceToken, m, doSubmit)
}
