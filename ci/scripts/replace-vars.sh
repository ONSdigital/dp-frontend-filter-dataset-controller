...
sed dp-frontend-dataset-controller/appspec.yml dp-frontend-dataset-controller/scripts/codedeploy/* -i \
...
cp dp-frontend-dataset-controller/appspec.yml artifacts/
cp dp-frontend-dataset-controller/scripts/codedeploy/* artifacts/scripts/codedeploy
