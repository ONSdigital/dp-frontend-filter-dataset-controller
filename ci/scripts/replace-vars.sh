...
sed dp-frontend-filter-dataset-controller/appspec.yml dp-frontend-filter-dataset-controller/scripts/codedeploy/* -i \
...
cp dp-frontend-filter-dataset-controller/appspec.yml artifacts/
cp dp-frontend-filter-dataset-controller/scripts/codedeploy/* artifacts/scripts/codedeploy
